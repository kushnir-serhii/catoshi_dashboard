...
export function buildScenario(startPrice: number, drift: number, seed: number): ForecastPoint[] {
...
export function buildProjection(cfg: CoinConfig): ProjectionData {
...
export function buildMockProjectionForCoin(target: ForecastTarget): ProjectionData {
